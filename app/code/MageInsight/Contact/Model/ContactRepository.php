...
use MageInsight\Contact\Model\ResourceModel\Contact as ObjectResourceModel;
use MageInsight\Contact\Model\ResourceModel\Contact\CollectionFactory;
...
class ContactRepository implements ContactRepositoryInterface
{
    ...
    public function getById($id)
    {
        ...
        $this->objectResourceModel->load($object, $id, 'contact_id');
        if (!$object->getId()) {
